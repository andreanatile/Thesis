...
# Extract feature
feature11=ft.All_Features(Yacc11,Xgyr11,Zgyr11,Time11,segment_length,overlap_percentage,sampling_rate,level,suffix)
...
# Extract features
feature08=ft.All_Features(Yacc08,Xgyr08,Zgyr08,Time08,segment_length,
...
Training_Dataset['Anomaly'].replace(['Mild', 'Severe','Span'], 'Anomaly', inplace=True)
#Save as csv file
Training_Dataset.to_csv("data/Training_Datasets/raw_Training_Dataset.csv",index=False)
