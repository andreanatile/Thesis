...
from featrures_extraction import features_extraction, SWT_Sym5, Combining_features, UpSampling
import pywt
...
features = Combining_features(upsampled_Sacc, upsampled_GyrX, upsampled_GyrZ, upsampled_Time, 1000, 0.66, 400, 3, [
                              'Acceleration y', 'Gyroscope x', 'Gyroscope z'])
print(len(features))
